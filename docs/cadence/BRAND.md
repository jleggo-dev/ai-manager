...
| Disruptions | `detours` (cause + duration) | **"My plan isn't working — I'm too busy"** (the door: one glass line at the top of the plan screen, the felt statement in the user's voice — owner ruling 2026-08-31, settled after a device look; the setup sheet keeps the "take a detour" framing) | cause is always named plainly (say "grief", never euphemize) |
