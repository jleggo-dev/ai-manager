...
import { detourEndingCopy, freezeSaveCopy, reEntryCopy, weatherMoveCopy, weeklyCheckinCopy } from './copy-push.ts';
...
export { detourEndingCopy, freezeSaveCopy, reEntryCopy, weatherMoveCopy, weeklyCheckinCopy } from './copy-push.ts';
