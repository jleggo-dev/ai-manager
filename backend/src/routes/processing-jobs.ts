...
router.post('/apply-formatting', validateBody(applyFormattingSchema), (req: Request, res: Response) => {
  try {
...
router.post('/', validateBody(createProcessingJobSchema), async (req: Request, res: Response) => {
  try {
    const {
      name,
      slug,
...
router.patch('/batch', validateBody(batchUpdateSchema), async (req: Request, res: Response) => {
  try {
...
router.put('/:id', validateBody(updateProcessingJobSchema), async (req: Request, res: Response) => {
  try {
...
router.post('/:id/datasources', validateBody(datasourceUploadSchema), async (req: Request, res: Response) => {
  try {
