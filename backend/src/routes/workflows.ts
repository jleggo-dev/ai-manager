...
router.post('/', validateBody(createWorkflowSchema), async (req: Request, res: Response) => {
  try {
...
router.put('/:id', validateBody(updateWorkflowSchema), async (req: Request, res: Response) => {
  try {
...
router.post('/:id/steps', validateBody(createWorkflowStepSchema), async (req: Request, res: Response) => {
  try {
...
router.put('/:wid/steps/:sid', validateBody(updateWorkflowStepSchema), async (req: Request, res: Response) => {
  try {
...
router.delete('/:wid/steps/:sid', async (req: Request, res: Response) => {
  try {
