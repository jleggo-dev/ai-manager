 ...
 *
 * The ring is also the door out to the whole day: a capture answers "what did I just eat", and the
 * question that raises next — "so where does that leave me" — lives in the Food screen, which had
 * no way in from here at all (owner device report, 2026-08-20). `onOpenFood` is optional because
 * not every host can route there; without it the ring is plain, exactly as before.
 */
