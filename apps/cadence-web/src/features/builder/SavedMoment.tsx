 ...
 */
export function SavedMoment({ name, onRunNow, onDone }: { name: string; onRunNow: () => void; onDone: () => void }) {
  return (
    <div className="ab-saved" role="region" aria-label="Saved">
      ...
      <div className="ab-saved-head">
        ...
        <div className="ab-saved-sub">It’s in Your activities and on the ＋ sheet.</div>
      </div>
