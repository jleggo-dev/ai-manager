...
import { syncPlanReminders } from './lib/reminders-sync.ts';
  ...
  useEffect(() => {
    getPlan()
      .then((p) => {
        ...
        // Reconcile on-device reminders with the plan we just loaded. Full replace, native-only,
        ...
        // not having listened.
        void syncPlanReminders(p.activities);
      })
