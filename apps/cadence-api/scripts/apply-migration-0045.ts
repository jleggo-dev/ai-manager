/**
 * Apply migrations/cadence/0045_progress_layouts.sql. Additive + idempotent, safe to re-run.
...
async function main() {
  ...
  await sql.unsafe(readFileSync(path.join(root, 'migrations/cadence/0045_progress_layouts.sql'), 'utf8'));
