...
import coachAttachmentRoutes from './routes/coach-attachments.ts';
...
import planOccurrenceEditRoutes from './routes/plan-occurrence-edit.ts';
...
import repertoireSeedRoutes from './routes/repertoire-seed.ts';
import repertoireCollectionsRoutes from './routes/repertoire-collections.ts';
...
import meRoutinesRoutes from './routes/me-routines.ts';
...
export function createApp() {
  ...
  app.use('/progress', repertoireCollectionsRoutes);
