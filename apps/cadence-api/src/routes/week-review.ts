 ...
 * GET /plan/week-review/facts[?week=YYYY-MM-DD] (W2-2), the write-back trio (check-in rebuild,
 * step 5): POST /plan/week-review/session, /meal, /mind-step, and `recap` (Progress Engine W2-1)
 * below them.
 *
